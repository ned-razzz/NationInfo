...
public class NationDataModel {
	...
	public static String SQL_CONTRY = "select contry from nation";
	...
	//특정 행 정보 전달
	public HashMap<String, String> getColumn_name(String contry) {
	...
	public ArrayList<String> find_contry(String type, String value) {
		...
		String sql = String.format(SQL_CONTRY + " where %s like '%%%s%%'", type, value);
